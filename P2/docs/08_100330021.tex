...
\par En este capítulo se va a explicar en primer lugar el algotitmo LVQ, una versión supervisada del método de Kohonen, clasificando por vecindad. El número de clases sobre las que se clasifica, es conocido de antemano.
