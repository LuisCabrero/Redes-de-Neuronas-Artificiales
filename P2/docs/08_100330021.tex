...
\par Utilizando 196 prototipos la situación es bastante semejante al caso de 180, pero se empeora ligeramente el porcentaje de acierto, ahora es de 70,8\%, por tanto la idea es probar un número de prototipos entre 180 y 196 para ver si se mejora el porcentaje de acierto obtenido en 180.
