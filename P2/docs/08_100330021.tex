...
\par El resultado obtenido en el caso de 15x15 es un porcentaje de acierto muy bajo teniendo en cuenta LVQ y MLP pero vamos a ver los resultados de la monitorización:
